...
export function CrmTopbar({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-between gap-4 border-b border-border bg-white px-4 md:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={signOut}
          className="inline-flex h-10 items-center gap-1.5 rounded-lg border border-border bg-white px-3 text-sm font-medium text-navy transition-colors hover:bg-surface"
        >
