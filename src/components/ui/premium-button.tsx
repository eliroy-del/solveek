  ...
  return (
    <Link
      ...
      className={cn(
        ...
        variant === "primary" &&
          "bg-[#7B2CBF] text-white shadow-[0_12px_30px_rgba(123, 44, 191,0.35)] hover:-translate-y-0.5 hover:bg-[#11112F] hover:shadow-[0_18px_40px_rgba(17, 17, 47,0.4)]",
        variant === "secondary" &&
          "bg-white text-navy shadow-soft hover:-translate-y-0.5 hover:bg-[#7B2CBF] hover:text-white hover:shadow-lift",
        variant === "ghost" &&
