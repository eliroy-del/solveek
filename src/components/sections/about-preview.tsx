      ...
      <div className="container-premium grid items-center gap-10 lg:grid-cols-2">
        <Reveal>
          <div className="relative mx-auto max-w-lg">
            <div className="relative grid grid-cols-[1.1fr_0.9fr] items-stretch gap-3">
              <div className="relative mt-6 min-h-[320px] overflow-hidden rounded-3xl shadow-lift">
                <Image
                  src={IMAGES.team}
              ...
              <div className="relative min-h-[320px] overflow-hidden rounded-3xl shadow-soft">
                <Image
        ...
        <div>
          <Reveal>
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-royal">
              Who we are
            </p>
            <h2 className="font-heading text-2xl leading-tight text-navy sm:text-3xl lg:text-4xl">
