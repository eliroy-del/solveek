  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      ...
      <button
        ...
        className="btn-shine inline-flex h-12 w-full items-center justify-center rounded-2xl bg-[#7B2CBF] font-semibold text-white shadow-[0_12px_30px_rgba(123, 44, 191,0.35)] transition hover:-translate-y-0.5 hover:bg-[#11112F] disabled:opacity-60"
      >
