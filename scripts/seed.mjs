...
async function main() {
  ...
  await upsert("projects", [
    {
      ...
      website_url: "https://www.royalhousebaltimore.org/",
      featured: true,
      sort_order: 0,
    },
    {
    ...
    },
    {
      ...
      solution: "Solveek designed and built Books and You—a premium e-commerce storefront with level browsing, secure checkout, and delivery workflows for Ghana families and schools.",
      ...
      website_url: "https://booksandyou.shop/",
      featured: true,
      sort_order: 4,
    },
  ]);
  ...
  await upsert("insights", [
    { slug: "conversion-first-website-design", title: "Conversion-First Website Design Without Sacrificing Craft", excerpt: "How premium visual design and clear UX architecture drive measurable outcomes.", body: "", category: "Design", author: "Solveek", date: "2026-06-12", read_time: "7 min", image: INSIGHT_IMAGES.websiteDesign, featured: true },
    { slug: "saas-onboarding-that-sticks", title: "SaaS Onboarding That Sticks", excerpt: "Practical UX patterns that help new users reach value faster.", body: "", category: "Product", author: "Solveek", date: "2026-05-28", read_time: "6 min", image: INSIGHT_IMAGES.saasOnboarding, featured: false },
    { slug: "social-systems-not-posts", title: "Build Social Systems, Not Just Posts", excerpt: "Why high-performing brands treat social as an operating system.", body: "", category: "Marketing", author: "Solveek", date: "2026-05-04", read_time: "8 min", image: INSIGHT_IMAGES.socialSystems, featured: false },
    { slug: "ecommerce-checkout-friction", title: "Where Checkout Friction Quietly Kills Revenue", excerpt: "A practical checklist for finding silent leaks between product page and purchase.", body: "", category: "E-commerce", author: "Solveek", date: "2026-04-18", read_time: "5 min", image: INSIGHT_IMAGES.checkout, featured: false },
    { slug: "design-systems-for-scale", title: "Design Systems That Keep Growing Brands Coherent", excerpt: "How reusable components accelerate shipping without diluting quality.", body: "", category: "Design", author: "Solveek", date: "2026-03-30", read_time: "9 min", image: INSIGHT_IMAGES.designSystems, featured: false },
    { slug: "ai-in-digital-products", title: "Using AI in Digital Products Without Losing Trust", excerpt: "A grounded approach to AI features that feel useful and brand-aligned.", body: "", category: "Technology", author: "Solveek", date: "2026-03-09", read_time: "6 min", image: INSIGHT_IMAGES.aiProducts, featured: false },
  ]);
    ...
    [
      {
        key: "brand_values",
        value: [
          { title: "Clarity", description: "We simplify complexity to enable teams and customers know what to do next." },
