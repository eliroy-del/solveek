...
async function main() {
  ...
  const PROJECT_IMAGES = {
    ecommerce: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1600&q=80",
  ...
  await upsert("projects", [
    ...
    },
    {
      ...
      image: PROJECT_IMAGES.saas,
      gallery: [PROJECT_IMAGES.saas, PROJECT_IMAGES.dashboard, PROJECT_IMAGES.metrics],
      featured: true,
      sort_order: 2,
    },
    {
