      ...
      <div className="container-premium">
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[32px] border border-border bg-navy-dark p-4 shadow-lift md:p-8">
            <div
              className="relative aspect-[16/9] w-full rounded-[24px] bg-[radial-gradient(circle_at_30%_30%,rgba(123,44,191,0.35),transparent_35%),radial-gradient(circle_at_70%_60%,rgba(155,77,219,0.2),transparent_40%),linear-gradient(160deg,#11112F,#3C1361)]"
              role="img"
              ...
              {hubs.map((hub, index) => (
                ...
                >
                  <span className="relative flex size-3.5 items-center justify-center">
                    ...
                    <span className="size-3.5 rounded-full bg-cyan shadow-[0_0_16px_rgba(155,77,219,0.8)]" />
                  </span>
                  <span
